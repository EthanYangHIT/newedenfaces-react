    ...
    _createClass(AddCharacterActions, [{
        ...
        value: function addCharacter(name, gender) {
            ...
            $.ajax({
                type: 'POST',
                url: '/api/characters',
                data: _defineProperty({ name: name, gender: gender }, 'gender', gender)
            }).done(function (data) {
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'nameTextField',
                                            value: this.state.name, onChange: _AddCharacterActions2.default.updateName,
                                            autoFocus: true }),
                                        _react2.default.createElement(
                                            'span',
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement('input', { type: 'radio', name: 'gender', id: 'male', value: 'Male',
                                        ...
                                        _react2.default.createElement(
                                            'div',
                                            { className: 'radio radio-inline' },
                                            _react2.default.createElement('input', { type: 'radio', name: 'gender', id: 'female', value: 'Female',
...
var AddCharacterStore = function () {
    function AddCharacterStore() {
        ...
        this.gender = '';
        this.helpBlock = '';
        this.nameValidtionState = '';
        this.genderValidtionState = '';
    }
